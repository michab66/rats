/* $Id: CloneablePill.java 115 2008-12-31 17:02:19Z binzm $
 *
...
/**
 * Pill can be moved with the mouse.  Maintains a source object.
 */
public class CloneablePill
  extends
    Pill
{
   ...
   */
  public CloneablePill( Applet app, AnimationGrid ag, GridPosition p )
  {
    super( app, ag, p );
