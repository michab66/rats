/* $Id: DragableStopTheFat.java 115 2008-12-31 17:02:19Z binzm $
 *
 ...
 */
public class DragableStopTheFat
  extends
    StopTheFat
{
   ...
   */
  public DragableStopTheFat( Applet app, AnimationGrid ag, GridPosition p )
  {
    super( app, ag, p );
