/* $Id: DragablePill.java 115 2008-12-31 17:02:19Z binzm $
 *
    ...
    Pill
{
   ...
   */
  public DragablePill( Applet app, AnimationGrid ag, GridPosition p )
  {
    super( app, ag, p );
    ...
    // If our target position has no south and north connections...
