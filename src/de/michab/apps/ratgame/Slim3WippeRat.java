/* $Id: Slim3WippeRat.java 115 2008-12-31 17:02:19Z binzm $
 *
 ...
 */
public class Slim3WippeRat
  extends
    RatLike
{
  private static String ourName = "Slim3WippeRat";
  private Applet app;
  private static boolean Debug = false;

  private int deathDir;
  ...
  public Slim3WippeRat( AnimationGrid ag, GridPosition p, int whatStrip )
  {
    super( ag, ourName );

    if ( null == strip || null == strip[ whatStrip ] )
    {
      System.out.println( "Slim3WippeRat: strip or strip idx invalid..." );
      return;
    }
    ag.addStrip( this, p, strip[ deathDir = whatStrip ] );
  }
  public Slim3WippeRat( Applet app )
  {
    super( null, ourName );
