/* $Id: CloneableStopTheFat.java 115 2008-12-31 17:02:19Z binzm $
 *
...
/**
 * StopTheFat can be moved with the mouse.  Maintains a source object.
 */
public class CloneableStopTheFat
  extends
    StopTheFat
{
   ...
   */
  public CloneableStopTheFat( Applet app, AnimationGrid ag, GridPosition p )
  {
    super( app, ag, p );
  ...
  public boolean mouseUp( Event evt, int x, int y, GridPosition p )
  {
    ...
    if ( ! p.equals( homePosition ) )
    {
      ...
      new DragableStopTheFat( null, home, p );
    }
